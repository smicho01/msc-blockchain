...
const MIN_NUM_TRANSACTIONS_TO_MINE = process.env.MIN_NUM_TRANSACTIONS_TO_MINE || 5
const AUTOMINE_POOL_EVERY_SECONDS = process.env.AUTOMINE_POOL_EVERY_SECONDS || 10
