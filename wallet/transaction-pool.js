...
class TractionPool {
    ...
    updateOrAddTransaction(transaction) {
        // Check if pool has zero transactions and reset its poolCreationTime to now
        // It is used to mine block if there is too low num of transactions to mie byt block is quite old
        ...
        // Transaction may exist in transactions table, so it need an update as transaction can have multiple outputs
